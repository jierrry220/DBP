...
const translations = {
    en: {
        ...
        'balance.frozenBalance': 'Frozen Balance:',
...
'game.msg.confirming': 'Confirming...',
        ...
        'partyCrisis.killerComing': 'Killer is Coming',
        'partyCrisis.killerAppears': '🚨Killer Appears!🚨',
        'partyCrisis.settling': 'Settling...',
        'partyCrisis.historyTitle': 'Kill Record',
        'partyCrisis.selectedRoom': 'Selected Room',
        'partyCrisis.betAmount': 'Bet Amount',
        'partyCrisis.room1': 'Office',
        'partyCrisis.room2': 'Bar',
        'partyCrisis.room3': 'Lounge',
        'partyCrisis.room4': 'Noble Suite',
        'partyCrisis.room5': 'Prestige Suite',
        'partyCrisis.room6': 'Diamond Suite',
        'partyCrisis.room7': 'Restaurant',
        'partyCrisis.room8': 'Dance Floor',
        'partyCrisis.resultWinTitle': 'You Are Amazing!',
        'partyCrisis.resultWinMessage': 'Successfully Escaped the Killer',
        'partyCrisis.resultLoseTitle': 'So Sorry!',
        'partyCrisis.resultLoseMessage': 'You Were Eliminated by the Killer!',
        'partyCrisis.noBetTitle': 'Next Round Winner Will Be You!',
        'partyCrisis.noBetMessage': 'Choose Your Hiding Room',
        'partyCrisis.earnedThisRound': 'Earned This Round',
        'partyCrisis.lostThisRound': 'Lost This Round',
        'partyCrisis.connectWalletFirst': 'Please connect wallet first',
        'partyCrisis.selectRoomFirst': 'Please select a room first',
        'partyCrisis.cannotSelectNow': 'Cannot select room now',
        'partyCrisis.alreadyBet': 'Already bet, cannot change room',
        'partyCrisis.getBalanceFailed': 'Failed to get balance',
        'partyCrisis.insufficientBalance': 'Insufficient balance',
...
'game.msg.confirming': '確認中...',
        ...
        'partyCrisis.killerComing': '殺手即将到来',
        'partyCrisis.killerAppears': '🚨殺手出现！🚨',
        'partyCrisis.settling': '结算中...',
        'partyCrisis.historyTitle': '刺殺记录',
        'partyCrisis.selectedRoom': '已选房间',
        'partyCrisis.betAmount': '已投注',
        ...
        'partyCrisis.noBetMessage': '选择你蹲藏的房间吧',
        'partyCrisis.earnedThisRound': '本局获得',
        'partyCrisis.lostThisRound': '本局损失',
        'partyCrisis.connectWalletFirst': '请先连接钱包',
        'partyCrisis.selectRoomFirst': '请先选择房间',
        'partyCrisis.cannotSelectNow': '现在不能选择房间',
        'partyCrisis.alreadyBet': '已下注，无法更换房间',
        'partyCrisis.getBalanceFailed': '获取余额失败',
        'partyCrisis.insufficientBalance': '余额不足',
